...
npm run build:radar | Out-Host

Write-Host "[integration] running fixture-backed daily radar"
$env:AI_RADAR_USE_FIXTURES = "1"
npx tsx scripts/run-radar.ts --dry-run --fixtures --report-date=2026-03-25 | Out-Host
