## Summary
Evaluate esengine/DeepSeek-Reasonix as a tool-plugin-integration candidate on an isolated branch with staging-only validation.

## Candidate Signals
- Active commits in last 30 days: 100
- Latest release: desktop-v1.13.0
- License: MIT
