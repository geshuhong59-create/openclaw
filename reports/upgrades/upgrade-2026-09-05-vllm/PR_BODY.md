## Summary
Evaluate vllm-project/vllm as a inference-framework-replacement candidate on an isolated branch with staging-only validation.

## Candidate Signals
- Active commits in last 30 days: 27
- Latest release: v0.8.2
- License: Apache-2.0
- Projected performance gain: 37%
- Projected cost reduction: 19%
